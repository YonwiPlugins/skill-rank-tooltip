...
- Provides an enabled-by-default checkbox for every skill and Total level.
...
When the development client is open, sign in, open the Skills tab, and hover over several skills. Confirm that the rank appears and the tooltip background grows to fit it. Disable Show ranks, then untick individual skill or Total level checkboxes and confirm the relevant tooltip rows no longer appear.
